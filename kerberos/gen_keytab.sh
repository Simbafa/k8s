...
kadmin.local -q "addprinc -randkey zookeeper/zookeeper-1.bigdata.svc.cluster.local@JUSTEP.COM"
kadmin.local -q "addprinc -randkey zookeeper/zookeeper-2.bigdata.svc.cluster.local@JUSTEP.COM"
kadmin.local -q "addprinc -randkey zookeeper/zookeeper-3.bigdata.svc.cluster.local@JUSTEP.COM"
...
kadmin.local -q "xst -k zookeeper.keytab -norandkey zookeeper/zookeeper-1.bigdata.svc.cluster.local@JUSTEP.COM"
kadmin.local -q "xst -k zookeeper.keytab -norandkey zookeeper/zookeeper-2.bigdata.svc.cluster.local@JUSTEP.COM"
kadmin.local -q "xst -k zookeeper.keytab -norandkey zookeeper/zookeeper-3.bigdata.svc.cluster.local@JUSTEP.COM"
