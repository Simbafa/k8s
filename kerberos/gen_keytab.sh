...
kadmin.local -q "addprinc -randkey zookeeper/zookeeper-1.hadoop.svc.cluster.local@JUSTEP.COM"
kadmin.local -q "addprinc -randkey zookeeper/zookeeper-2.hadoop.svc.cluster.local@JUSTEP.COM"
kadmin.local -q "addprinc -randkey zookeeper/zookeeper-3.hadoop.svc.cluster.local@JUSTEP.COM"
...
kadmin.local -q "xst -k zookeeper.keytab -norandkey zookeeper/zookeeper-1.hadoop.svc.cluster.local@JUSTEP.COM"
kadmin.local -q "xst -k zookeeper.keytab -norandkey zookeeper/zookeeper-2.hadoop.svc.cluster.local@JUSTEP.COM"
kadmin.local -q "xst -k zookeeper.keytab -norandkey zookeeper/zookeeper-3.hadoop.svc.cluster.local@JUSTEP.COM"
